	...
	m_pNodePropertiesWidget(NULL)
{
	...
	gTransferFunction.AddNode(new QNode(m_pTransferFunction, 0.0f, 0.0f, QColor(255, 0, 0, 128), false));
	gTransferFunction.AddNode(new QNode(m_pTransferFunction, 70.0f, 0.5f, QColor(255, 160, 30, 255)));
	gTransferFunction.AddNode(new QNode(m_pTransferFunction, 100.0f, 0.1f, QColor(55, 160, 255, 255)));
	gTransferFunction.AddNode(new QNode(m_pTransferFunction, 255.0f, 1.0f, QColor(10, 255, 0, 128), false));
}