...
protected:
	...
	QLabel				m_ThetaLabel;
	QFloatSlider		m_ThetaSlider;
	QDoubleSpinner		m_ThetaSpinBox;
	QLabel				m_PhiLabel;
	QFloatSlider		m_PhiSlider;
	QDoubleSpinner		m_PhiSpinBox;
	QLabel				m_DistanceLabel;
	QFloatSlider		m_DistanceSlider;
	QDoubleSpinner		m_DistanceSpinBox;
	QLabel				m_WidthLabel;
	QFloatSlider		m_WidthSlider;
	QDoubleSpinner		m_WidthSpinBox;
	QLabel				m_HeightLabel;
	QFloatSlider		m_HeightSlider;
	...
	QFloatSlider		m_IntensitySlider;
