...
KERNEL void KrnlComputeEstimate(CScene* pScene, CColorXyz* pEstFrameXyz, CColorXyz* pAccEstXyz, CColorXyz* pEstXyz, CColorRgbaLdr* pPixels, float N, CVariance* pVariance)
{
...
void ComputeEstimate(CScene* pScene, CScene* pDevScene, CColorXyz* pEstFrameXyz, CColorXyz* pAccEstXyz, CColorXyz* pEstXyz, CColorRgbaLdr* pPixels, float N, CVariance* pVariance)
{
	...
	KrnlComputeEstimate<<<KernelGrid, KernelBlock>>>(pDevScene, pEstFrameXyz, pAccEstXyz, pEstXyz, pPixels, N, pVariance); 
}